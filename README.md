...
1. Listeners (main.js) intercept events.
2. Event Handlers (/js/eventHandlers/) process logic and call APIs.
3. API functions (/js/api/) receive data from server endpoints.
4. Render functions (/js/rendering/) display data in the interface.
